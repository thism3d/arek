...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $stmt = $conn->prepare('INSERT INTO new_artist_requests (fullname, email ) VALUES(?, ? );');
    ...
    if($stmt->execute()){
      ...
      $email_message = '<p><i>New artist request from <b>' . $fullname . '</b> has been received successfully</i></p>.<br><br><p>Email: '. $email .'</p><p>Full Name: '. $fullname .'</p>';
