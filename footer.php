        <div id="follow_us" class="follow_social_media">
            ...
            <div class="follow_us_item_contianer">
                <a class="follow_us_item" href="https://www.facebook.com/ModernAfroCaribbeanArt/"><img src="assets/social/facebook.svg.webp" alt="InterFineArt | Follow us on Facebook: @ModernAfroCaribbeanArt"></a>
                <a class="follow_us_item" href="https://instagram.com/blackeritaj"><img src="assets/social/instagram.png" alt="InterFineArt | Follow us on Instagram: @blackeritaj"></a>
        ...
        <footer class="footer">
            <div id="contact_us" class="footer_item">
                ...
                <div class="footer_item_contents_keeper">
                    ...
                    <a class="footer_item_content_anchor" target="_blank" href="https://maps.app.goo.gl/cVyEz7xeiRaMBzvc6">6919 W Broward Blvd Suite 313 Plantation, FL 33317</a>
                    ...
                    <a class="footer_item_content_anchor" href="mailto:jacompas@interfineart.com">jacompas@interfineart.com</a>
                </div>
            </div>
            ...
            <div class="footer_item">
                ...
                <div class="footer_content_form">
                    <div class="input_fields_keeper_member_l">
                        <input id="fullname_input" class="input_items_member_l" name="user_fullname" type="text" placeholder="" required>
                    ...
                    <div class="input_fields_keeper_member_l">
                        <input id="email_input" class="input_items_member_l" name="user_email" type="text" placeholder="" required>
                    ...
                    <div class="input_fields_keeper_member_l">
                        <textarea id="user_message" class="input_items_member_l" name="user_message" type="text" placeholder="" required style="resize: vertical;"></textarea>
            ...
            <div class="footer_item footer_item_extended">
                ...
                <div class="footer_item_contents_keeper">
                    <div class="footer_item_links_container">
                        ...
                        <a class="footer_item_link" href="http://editionsvieuxventcaraibes.com/">Les Éditions Vieux Vent Caraïbes</a>
        ...
        <div class="wide_container"> <!-- Wide Container -->
        ...
        <div id="art_galley_pvc" class="art_gallery_picture_viewer_container">
            <div id="art_gallery_pv_inside" class="art_gallery_picture_viewer_inside" style="max-width: 900px;">
                <img id="art_gallery_picture_viewer" class="art_gallery_picture_viewer" style="max-width: 900px;" src="">
                <a class="all_view_container_close_btn art_gallery_picture_close_btn" onclick="close_the_preview()"><i class="fa fa-remove"></i></a>
            </div>
        </div>
