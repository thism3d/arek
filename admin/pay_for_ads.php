...
<div class="admin_middle_box_conatiner">
	...
	<div class="task_all_viewer_container">
			...
			<div class="task_view_all_confirmer">

				<?php

					if($maintainance_break){
						echo '
						<form method="post" action="add_ads_task_complete_server">
							<input type="hidden" name="confirm_all_payment" value="kmIUNsdOKASy1237HKJkdklqeNMAJjfiwoeNYC78aJAHJHSDllweirNJ">
							<button type="submit" class="accept_wtihdraw_button"><span class="material-icons">check</span> CONFIRM PAYMENT</button>
						</form>
						';
					}else{
						echo '<p>Turn Maintainance On To Confirm Payments For Tasks</p>';
					}
