...
$title = "Arek Property Management | Downloaded Users List";
...
<div class="admin_middle_box_conatiner">
	...
	<div class="admin_middle_box_conatiner">
		...
		<div class="task_all_viewer_container">
			...
			<h2 style="color: #009688" class="all_r_task_header">Brochure Downloads</h2>
							...
							echo '
								<div class="mystd_single_student_container">
									...
									<div class="mystd_comment_keeper">
										...
										<form method="post" action="downloads_application_delete">
											<input type="hidden" name="profile_id" value="'. $row["id"] .'">
											<button onClick="return confirmSubmitWithPopup(this, \'Do you really want to delete the data of '. $row["name"] .' ?\')" type="submit" class="all_member_active_rec_btn">
